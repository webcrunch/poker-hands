...
test('check that isHighest returns a higher score for a stronger hand and give less score to the first hand at this example (if two hands both with nothing but highest card)', () => {
